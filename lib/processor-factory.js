...
function factory(Promise, Object, shim_array, workerpool, utils, createLoggerFactory, converterFactory)
{
	...
	function handleRecordProcessing(record, parameters, steps, result_previous)
	{
	    ...
	    return processRecord(record, spec_steps, result_previous);
	...
	function processRecord(record_data, spec_steps, processing_results)
	{
	    ...
	    processing_results = processing_results ? processing_results : {
		results: {
