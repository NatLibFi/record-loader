...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['es6-polyfills/lib/promise', 'es6-polyfills/lib/object', 'loglevel', 'jjv', 'jjve', '../resources/config-schema.json'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('es6-polyfills/lib/promise'), require('es6-polyfills/lib/object'), require('loglevel'), require('jjv'), require('jjve'), require('../resources/config-schema.json'));
    }

}(this, factory));

function factory(Promise, Object, log, jjv, jjve, schema)
{
